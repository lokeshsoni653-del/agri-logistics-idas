...
PHRASE_BOOK: dict = {
    ...
    "At end of road, turn": {
        ...
        "Dhatki":  "Raah khatam, phiro",
    },

    # ── Arrival ─────────────────────────────────────────────────
    "Arrive at destination": {
        "Sindhi":  "Manzil te pahuncha. Safar khatam thiyo.",
        "Urdu":    "Manzil par pahunch gaye. Safar mukammal hua.",
        "Dhatki":  "Thaur te pahuncha. Safar khatam thio.",
    },
}
...
def _translate_instruction(instruction: str, language: str) -> str:
    ...
    # Strip stray English prepositions from the start of the suffix
    for prep in ["onto ", "on ", "to ", "at "]:
        if suffix.lower().startswith(prep):
            suffix = suffix[len(prep):].strip()
            break
